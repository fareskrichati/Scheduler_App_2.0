...
let authMode = savedAuthProfile ? "login" : "signup";
...
const authState = {
  ...
  isAuthenticated: Boolean(savedAuthProfile && localStorage.getItem(SESSION_KEY) === "active"),
};
...
function finishFirstLoginSetup() {
